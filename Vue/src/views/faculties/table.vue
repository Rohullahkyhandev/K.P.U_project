<template>
    <div class="mt-10">
        <div
            class="bg-white p-6 rounded shadow animate-fade-in-down overflow-auto"
        >
            ...
            <table class="table-auto w-full mb-4 rounded-lg">
                <thead>
                    <tr>
                        <th colspan="4"></th>
                    </tr>
                ...
                <tbody>
                    <tr>
                        <td
                            class="border-b-1 border-gray-700 border-t-1 p-2 bg-gray-200 mb-4 text-center"
                        >
                            &nbsp;&nbsp;<b>
                                <span class="font-bold text-xl"> دیپارمنت های این فاکولته </span>
                                &nbsp;&nbsp;
                            </b>
                        </td>
                        <br />
            ...
            <div class="flex justify-between border-b-2 pb-3">
                <div>
                    <input
                        v-model="search"
                        @change="getFacultyDepartment(null)"
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3"
                        >پیداشد {{ faculty_departments.total }} دیتا</span
                    >
                </div>
            </div>
            <table class="table-auto w-full">
                ...
                <tbody v-else>
                    ...
                    >
                        ...
                        <td class="border-b p-2">
                            <img
                                :src="faculty_department.photo_path"
                                width="100px"
                                height="100px"
            ...
            <div
                v-if="!faculty_departments.loading"
            ...
            >
                ...
                <nav
                    v-if="faculty_departments.total > faculty_departments.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination"
                >
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a
                        v-for="(link, i) of faculty_departments.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
