    ...
    <div class="mt-10 mb-10 w-full">
        ...
        <form @submit.prevent="onSubmit">
            <div class="w-full py-8 bg-white shadow mt-8 px-4">
                ...
                <div>
                    <div class="border-b py-2">
                        <h1 class="font-bold text-xl ">فورم ویرایش اطلاعات فاکولته </h1>
                    </div>
                </div>
                <div class="mt-5">
                    <div class="md:flex items-center justify-center">
                        <div class="w-2/12">
                            <label class="block text-gray-500 md:text-right mb-1 md:mb-0 pr-4">نام فاکولته
            ...
            <footer class="bg-gray-100 py-4  md:flex gap-5">
                <button type="submit"
                    :class="[facultyStore.loading === true ? 'bg-green-600 mr-10 text-white py-2 px-6 cursor-not-allowed rounded focus:ring focus:ring-green-500' : 'bg-green-600 mr-10 text-white py-2 px-6 cursor-pointer rounded focus:ring focus:ring-green-500']">
...
function onSubmit() {
    facultyStore.updateFaculty(faculty.value);
}
