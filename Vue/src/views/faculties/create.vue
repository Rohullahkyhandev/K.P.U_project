    ...
    <div class="mt-10 mb-10 w-full">
        ...
        <form @submit.prevent="onSubmit">
            <div class="w-full py-8 bg-white shadow mt-8 px-4">
                ...
                <div>
                    <div class="border-b py-2">
                        <h1 class="font-bold text-xl mb-3">فورم ثبت اطلاعات فاکولته </h1>
                    </div>
                </div>
                <div class="mt-5">
                    <div class="md:flex md:items-center md:justify-center">
                        <div class="w-2/12">
                            <label class="block text-gray-500 md:text-left mb-1 md:mb-0">نام فاکولته
                    ...
                    <div class="md:flex md:items-center md:justify-center">
                        <div class="w-2/12">
                            <label class="block text-gray-500 md:text-left mb-1 md:mb-0 ">تاریخ تأسیس<span
                                    class="text-red-500 px-4">*</span></label>
                        </div>
                        <div class="md:w-6/12">
                            <CustomInput type="date" v-model="faculty.date" class="mb-2" required="required" />
                        </div>
                    </div>

                    <div class="md:flex items-center justify-center">
                        <div class="md:w-2/12 md:items-center">
                            <label class="block text-gray-500 md:text-left mb-1 md:mb-0 ">توضیحات<span
                                    class="text-red-500 px-4">*</span></label>
                        </div>
                        <div class="md:w-6/12 md:items-center md:justify-center">
            ...
            <footer class="bg-gray-100 py-4  md:flex gap-5">
                <button type="submit"
                    :class="[facultyStore.loading === true ? 'bg-green-600 mr-10 text-white py-2 px-6 cursor-not-allowed rounded-lg focus:ring focus:ring-green-500' : 'bg-green-600 mr-10 text-white py-2 px-6 cursor-pointer rounded-lg focus:ring focus:ring-green-500']">
