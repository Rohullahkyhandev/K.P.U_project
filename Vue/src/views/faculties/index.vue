<template>
    <div class="px-5 mt-10">
        <div class="flex items-center justify-between mb-8">
            <div>
                <router-link :to="{ name: 'app.faculty.create' }"
            ...
            <div>
                <h1 class=" font-bold text-xl ">لیست فاکولته ها</h1>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded shadow animate-fade-in-down overflow-auto">
            ...
            <table class="table-auto w-full">
                ...
                <tbody v-else>
                    <tr v-for="(faculty, index) of faculties.data">
                                ...
                                <transition enter-active-class="transition duration-100 ease-out"
                                    ...
                                    <MenuItems
                                        ...
                                        <div class="px-1 py-1">
                                            ...
                                            <router-link :to="{ name: 'app.faculty.details', params: { id: faculty.id } }"
                                                :class="[
                                        ...
                                        <div class="px-1 py-1">
                                            <MenuItem v-slot="{ active }">
                                            <router-link :to="{ name: 'app.faculty.edit', params: { id: faculty.id } }"
                                                :class="[
                                                    active ? 'bg-blue-800 text-white' : 'text-gray-900',
                                                    'group flex w-full items-center rounded-md gap-3 px-2 py-2 text-sm',
                                                ]">
                                        ...
                                        <div class="px-1 py-1">
                                            <MenuItem v-slot="{ active }">
                                            <button @click="deleteFaculty(faculty.id)" :class="[
                                                active ? 'bg-blue-800 text-white' : 'text-gray-900',
                                                'group flex w-full items-center rounded-md gap-3 px-2 py-2 text-sm',
                                            ]">
                ...
                <nav v-if="faculties.total > faculties.limit"
                    ...
                    <a v-for="(link, i) of faculties.links" :key="i" :disabled="!link.url" href="#"
                        ...
                        :class="[
                            ...
                            i === 0 ? 'rounded-l-md' : '',
                            i === faculties.links.length - 1 ? 'rounded-r-md' : '',
