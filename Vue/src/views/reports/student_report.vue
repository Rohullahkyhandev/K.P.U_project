    ...
    <div class="form--padding--top">
        <div class="flex items-center justify-between w-full">
            <div>
                <h1 class="text--header">
                    فورم تهیه نمودن راپور محصلین برنامه های فوق لیسانس
                </h1>
            </div>
        </div>
        ...
        <form>
            <div class="wrapper--dev--form">
                <div>
                    ...
                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label for="" class="form--label">
                                انتخاب وضعیت<span class="label--prefix"
                                    >*</span
                                ></label
                            >
                        </div>
                    ...
                    <div
                        ...
                        v-if="reportData.type == 'base_on_program'"
                    >
                        <div class="label--dev--width">
                            <label for="" class="form--label">
                                انتخاب برنامه<span class="label--prefix"
                                    >*</span
                                ></label
                            >
                        </div>
            ...
            <footer class="bg-gray-100 py-4 md:flex gap-5">
                <a
                    v-if="reportData.type != '' && reportData.status != ''"
                    :href="
                        ExportUrl +
                        reportData.type +
                        '/' +
...
const ExportUrl = `http://localhost/ViceChancellor/public/student/report/`;
