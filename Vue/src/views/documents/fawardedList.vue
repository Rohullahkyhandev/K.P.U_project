<template>
    <div class="mt-10 sm:mx-10 md:mx-8 lg:mx-8">
        <div class="flex max-au items-center justify-between mb-6">
        ...
        <div class="table--wrapper--dev">
            ...
            <div class="flex justify-between border-b-2 pb-3">
                <div>
                    <input v-model="search" @change="getFarwardedDocument(null)"
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <select dir="ltr" @change="getFarwardedDocument(null)" v-model="perPage"
            ...
            <table class="table-auto w-full border">
                <thead>
                    <tr>
                        ...
                        <TableHeaderCell field="status" :sortDirection="sortDirection" :sortField="sortField"
                ...
                <tbody v-else>
                    <tr v-for="(
                        ...
                        ) of farwardedDocuments.data" :key="index">
        ...
        'group flex w-full items-center rounded-md gap-3 px-2 py-2 text-sm',
                                        ...
                                        <div class="px-1 py-1">
                                            <MenuItem v-slot="{ active }">
                                            <a :href="farwaded_document.attachment_path
                                                " :class="[
                                                    active
                                                        ? 'bg-blue-800 text-white'
                                                        : 'text-gray-900',
            ...
            <div v-if="!farwardedDocuments.loading" class="flex justify-between items-center mt-5" dir="ltr">
                <div v-if="farwardedDocuments.data">
                    نمایش از {{ farwardedDocuments.from }} تا
                    {{ farwardedDocuments.to }}
                </div>
                <nav v-if="farwardedDocuments.total > farwardedDocuments.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination">
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a v-for="(link, i) of farwardedDocuments.links" :key="i" :disabled="!link.url" href="#"
        ...
        <!-- Modal box -->
        <WrapperModal :close-modal="closeModal" :title="'فورم ثبت مکتوب  وارده'" :isOpen="isOpen">
            <createModal :close-modal="closeModal" :document_id="document_id" :farward_id="farward_id" />
        </WrapperModal>
        <!-- end Modal box -->
        <br /><br />
    </div>
