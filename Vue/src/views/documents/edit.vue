<template>
    <div class="form--padding--top">
        <div class="flex items-center justify-between w-full">
            <div>
                <router-link :to="{ name: 'app.document.list' }" class="header--button">
        ...
        <form @submit.prevent="onSubmit">
            <div class="wrapper--dev--form">
                ...
                <div>
                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label for="" class="form--label">
                                شماره مکتوب<span class="label--prefix">*</span></label>
                        </div>
                        <div class="input--dev--width">
                            <CustomInput type="number" v-model="document.number" class="mb-2" required="required"
                    ...
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput type="text" v-model="document.title" class="mb-2" required="required" />
                        </div>
                    </div>
                    ...
                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label for="" class="form--label">
                                مبداء مکتوب<span class="label--prefix">*</span></label>
                        </div>
                        <div class="input--dev--width">
                            <CustomInput type="text" v-model="document.source" class="mb-2" required="required" />
                        </div>
                    </div>
                    ...
                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label for="" class="form--label">
                                مرجع مکتوب<span class="label--prefix">*</span></label>
                        </div>
                        <div class="input--dev--width">
                            <CustomInput type="text" v-model="document.destination" class="mb-2" required="required" />
                        </div>
                    </div>

                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label for="" class="form--label">تاریخ ثبت<span class="label--prefix">*</span></label>
                        </div>
                        <div class="input--dev--width">
                            <DatePicker v-model="document.date" class="mb-2" required="required"
                    ...
                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label for="" class="form--label">
                                نوع مکتوب<span class="label--prefix">*</span></label>
                        </div>
                        <div class="input--dev--width">
                            <CustomInput type="select" :select-options="document_types" v-model="document.type"
                                class="mb-2" required="required" label=" نوع مکتوب" />
                        </div>
                    </div>

                    <div class="wrapper--dev--input" v-if="document.type == 'صادره'">
                        <div class="label--dev--width">
                            <label for="" class="form--label">
                        ...
                        <div class="input--dev--width mb-2">
                            <span> می شود</span>
                            <span @click="checkbox = true" class="cursor-pointer text-green-400 font-semibold">
                                &check;
                            </span>
                            &nbsp; &nbsp; &nbsp;
                            <span> یا خیر</span>
                            <span @click="checkbox = false" class="cursor-pointer text-red-500 font-semibold">
                                &cross;
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="wrapper--dev--input" v-if="checkbox == true">
                        <div class="label--dev--width">
                            <label for="" class="form--label">
                                بخش ها<span class="label--prefix">*</span></label>
                        </div>
                        <div class="input--dev--width">
                            <CustomInput type="select" :select-options="parts" v-model="document.department_part"
                    ...
                    ">
                        <div class="label--dev--width">
                            <label for="" class="form--label">
                                پوهنځی ها<span class="label--prefix">*</span></label>
                        </div>
                        <div class="input--dev--width">
                            <MultiSelect v-model="document.farwarded_parts" :options="faculties" optionLabel="name"
                                filter placeholder=" انتخاب پوهنځی" :maxSelectedLabels="5"
                    ...
                    ">
                        <div class="label--dev--width">
                            <label for="" class="form--label">
                                آمریت ها پنچگانه<span class="label--prefix">*</span></label>
                        </div>
                        <div class="input--dev--width">
                            <!-- <select
                            ...
                            <MultiSelect v-model="document.farwarded_parts" :options="chanceDepartments"
                                optionLabel="name" filter placeholder=" انتخاب آمریت" :maxSelectedLabels="5"
                                class="w-full mb-2 shadow-sm border-gray-300 focus:ring focus:ring-indigo-500" />
                        </div>
                    </div>
                    ...
                    ">
                        ...
                        <div class="input--dev--width">
                            <MultiSelect v-model="document.farwarded_parts" :options="departments" optionLabel="name"
                                filter placeholder=" انتخاب دیپارتمنت" :maxSelectedLabels="5"
                                class="w-full mb-2 shadow-sm border-gray-300 focus:ring focus:ring-indigo-500" />
                        </div>
                    </div>
                    ...
                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label for="" class="form--label">
                                اسکن مکتوب<span class="label--prefix">*</span></label>
                        </div>
                        <div class="input--dev--width">
                            <CustomInput type="file" @change="(file) => (document.attachment = file)" class="mb-2"
                                required="required" />
                        </div>
                    </div>
                    ...
                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label for="" class="form--label">
                                ملاحظات<span class="label--prefix">*</span></label>
                        </div>
                        <div class="input--dev--width">
                            <CustomInput type="textarea" v-model="document.remark" class="mb-2" required="required" />
                        </div>
                    </div>
                    ...
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput type="textarea" v-model="document.description" class="mb-2" />
                        </div>
                    </div>
                </div>
            </div>
            <footer class="bg-gray-100 py-4 md:flex gap-5">
                ...
                <router-link :to="{ name: 'app.document.list' }" class="footer--button--cancel">لغو ویرایش</router-link>
            </footer>
        </form>
    </div>
</template>
...
onMounted(() => {
    documentStore.editDocument(route.params.id)
