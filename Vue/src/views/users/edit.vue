        ...
        <form @submit.prevent="onSubmit" enctype="multipart/form-data">
            <div class="wrapper--dev--form">
                ...
                <div class="mt-5">
                    ...
                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label for="" class="form--label">آدرس ایمیل<span class="text-red-500 px-2">*</span></label>
                        </div>
                        <div class="input--dev--width">
                    ...
                    <div class="md:flex md:items-center md:justify-center" v-if="
...
">
            ...
            <footer class="bg-gray-100 py-4 md:flex gap-5">
                ...
                <router-link :to="{ name: 'app.user.list' }" class="footer--button--cancel">لغو ویرایش</router-link>
            </footer>
        </form>
    </div>
</template>
...
const user_type = ref([
    ...
    { key: "fifth_department", text: "آمریت های چهار  گانه" },
]);
