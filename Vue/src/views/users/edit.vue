    ...
    <div class="mt-10 mb-10 w-full">
        ...
        <form @submit.prevent="onSubmit">
            <div class="w-full py-8 bg-white shadow mt-8 px-4">
                ...
                <div class="bg-green-700 text-white rounded py-4 text-center" v-if="userStore.msg_success">
                ...
                <div class="bg-red-500 text-white py-4 rounded text-center" v-if="userStore.msg_wrang">
                    <div class="flex items-center justify-between px-10">
                        <div
                ...
                <div class="mt-5">
                    <div class="md:flex items-center justify-center">
                        <div class="w-2/12">
                            <label for="" class=" text-gray-600">نام کامل کابر<span
                    ...
                    <div class="md:flex items-center justify-center">
                        <div class="w-2/12">
                            <label for="" class=" text-gray-600 ">آدرس ایمل<span class="text-red-500 px-2">*</span></label>
                        </div>
                        <div class="w-6/12">
                    ...
                    <div class="md:flex items-center justify-center">
                        <div class="w-2/12">
                            <label for="" class=" text-gray-600">جایگاه کاری<span class="text-red-500 px-2">*</span></label>
                        </div>
                        <div class="w-6/12">
                    ...
                    <div class="md:flex items-center justify-center">
                        <div class="w-2/12">
                            <label for="" class=" text-gray-600 ">بخش مربوط<span class="text-red-500 px-2">*</span></label>
                        </div>
                        <div class="w-6/12">
                    ...
                    <div class="md:flex items-center justify-center">
                        <div class="w-2/12">
                            <label for="" class="  text-gray-600">رمز عبور<span class="text-red-500 px-2"></span></label>
                        </div>
                        <div class="w-6/12">
                            <CustomInput type="password" v-model="user.password" class="mb-2" />
                        </div>
                    </div>

                    <div class="md:flex items-center justify-center">
                        <div class="w-2/12">
                            <label for="" class=" text-gray-600 ">تا‌ید رمز عبور<span
                                    class="text-red-500 px-2">*</span></label>
                        </div>
                        <div class="w-6/12">
                    ...
                    <div class="md:flex items-center justify-center">
                        <div class="w-2/12">
                            <label for="" class=" text-gray-600 ">عکس<span class="text-red-500 px-2"></span></label>
                        </div>
                        <div class="w-6/12">
            ...
            <footer class="bg-gray-100 py-4  md:flex gap-5">
                <button type="submit"
                    class="bg-green-600 mr-10 text-white py-2 px-6 cursor-pointer rounded focus:ring focus:ring-green-500">ویرایش</button>
