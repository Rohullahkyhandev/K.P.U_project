<template>
    <div class="px-5 mt-10">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <router-link :to="{ name: 'app.user.permission_create', params: { id: $route.params.id } }"
            ...
            <div>
                <h1 class=" font-bold text-xl ">لیست صلاحیت ها</h1>
            </div>
        </div>
        <div class="bg-white p-6 rounded shadow animate-fade-in-down overflow-auto">
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <select @change="getPermissions(null)" dir="ltr" v-model="perPage"
                    ...
                    &nbsp;
                    <span class="ml-3">پیداشد {{ permissions.total }} کابر</span>
                </div>
            </div>
            ...
            <table class="table-auto w-full">
                <thead>
                    <tr>
                        <TableHeaderCell field="id">
                            شماره.
                        </TableHeaderCell>

                        <TableHeaderCell field="name">
                            صلاحیت
                        </TableHeaderCell>


                        <TableHeaderCell field="uname">
                            کاربر
                        </TableHeaderCell>
                ...
                <tbody v-if="permissions.loading || !permissions.data.data?.length">
                    <tr>
                        <td colspan="6">
                                ...
                                <transition enter-active-class="transition duration-100 ease-out"
                                    ...
                                    <MenuItems
                                        ...
                                        <div class="px-1 py-1">
                                            ...
                                            <button @click="deletePermission(permission.id)" :class="[
            ...
            <div v-if="!permissions.loading" class="flex justify-between items-center mt-5" dir="ltr">
                <div v-if="permissions.data">
                    نمایش از {{ permissions.from }} تا {{ permissions.to }}
                </div>
                <nav v-if="permissions.total > permissions.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination">
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a v-for="(link, i) of permissions.links" :key="i" :disabled="!link.url" href="#"
...
function deletePermission(id) {
    ...
    if (!confirm(`آیا شما موخواهید این صلاحیت را حذف نماید؟`)) {
        return
    }
    userStore.deletePermission(id);
    getPermissions();
}
