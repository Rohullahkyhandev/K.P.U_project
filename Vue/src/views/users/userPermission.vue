<template>
    <div class="form--padding--top">
        <div class="flex items-center justify-between mb-8">
            ...
            <div>
                <h1 class="text--header">لیست صلاحیت ها</h1>
            </div>
        </div>
        <div
        ...
        >
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3"
                        >پیداشد {{ permissions.total }} کابر</span
                    >
                </div>
            </div>
            ...
            <table class="table-auto w-full">
                <thead>
                    <tr>
                        <TableHeaderCell field="id"> شماره. </TableHeaderCell>

                        <TableHeaderCell field="name"> صلاحیت </TableHeaderCell>

                        <TableHeaderCell field="uname"> کاربر </TableHeaderCell>
                ...
                <tbody
                    v-if="permissions.loading || !permissions.data.data?.length"
                >
                    <tr>
                        <td colspan="6">
