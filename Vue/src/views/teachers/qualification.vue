<template>
    <div class="mt-10 mb-10 w-full">
        <div class="flex items-center justify-between w-full">
            ...
            <div>
                <h1 class="font-bold text-xl">فورم ثبت اسناد تحصلی استادان</h1>
            </div>
        </div>
            ...
            <div class="w-full py-8 bg-white shadow mt-8 px-4">
                ...
                <div class="mt-5">
                    <div class="md:flex md:items-center md:justify-center">
                        ...
                        <div class="md:w-6/12">
                            <CustomInput type="text" v-model="teacher_qualification.education_degree" class="mb-2"
                                required="required" />
                        </div>
                    </div>
                    ...
                    <div class="md:flex md:items-center md:justify-center">
                        ...
                        <div class="md:w-6/12">
                            <CustomInput type="text" v-model="teacher_qualification.country" class="mb-2"
                                required="required" />
                        </div>
                    </div>
                    ...
                    <div class="md:flex md:items-center md:justify-center">
                        ...
                        <div class="md:w-6/12">
                            <CustomInput type="text" v-model="teacher_qualification.university" class="mb-2"
                                required="required" />
                        </div>
                    </div>
                    ...
                    <div class="md:flex md:items-center md:justify-center">
                        ...
                        <div class="md:w-6/12">
                            <CustomInput type="date" v-model="teacher_qualification.graduated_year" class="mb-2"
                                required="required" />
                        </div>
                    </div>
...
const teacher_qualification = computed(() => teacherStore.teacher_qualification);


function onSubmit() {
    let id = route.params.id;
    teacherStore.createQualification(teacher_qualification.value, id);
}
