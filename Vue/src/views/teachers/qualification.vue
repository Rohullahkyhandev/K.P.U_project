        ...
        <form @submit.prevent="onSubmit">
            <div class="w-full py-8 bg-white shadow mt-8 px-4">
                ...
                <div class="mt-5">
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput type="text" :select-options="education_degrees"
                                v-model="qualification.education_field" class="mb-2" required="required" />
                        </div>
                    </div>
                    ...
                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label class="form--label">مقطع تحصیلی
                                <span class="label--prefix">*</span>
                            </label>
                        </div>
                        <div class="input--dev--width">
                            <CustomInput type="select" :select-options="education_degrees"
                                v-model="qualification.education_" class="mb-2" required="required" />
                        </div>
                    </div>
                    ...
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput type="text" v-model="qualification.country" class="mb-2" required="required" />
                        </div>
                    </div>

                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label class="form--label">پوهنتون
                                <span class="label--prefix">*</span>
                            </label>
                        </div>
                        <div class="input--dev--width">
                            <CustomInput type="text" v-model="qualification.university" class="mb-2"
                                required="required" />
                        </div>
                    </div>
                    ...
                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label class="form--label">سال شمولیت
                                <span class="label--prefix">*</span>
                            </label>
                        </div>
                        <div class="input--dev--width">
                            <DatePicker :config="config" format="y" type="date" v-model="qualification.admission_year"
                                class="mb-2" placeholder=" انتخاب تاریخ" required="required" />
                        </div>
                    </div>
                    ...
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <DatePicker :config="config" format="y" type="date" v-model="qualification.graduated_year"
                                class="mb-2" placeholder=" انتخاب تاریخ" required="required" />
                        </div>
                    </div>
                ...
                <div class="wrapper--dev--input">
                    ...
                    <div class="input--dev--width">
                        <CustomInput type="textarea" v-model="qualification.description" class="mb-2" />
                    </div>
                </div>
            </div>
            ...
            <footer class="bg-gray-100 py-4 md:flex gap-5">
                <button :disabled="teacherStore.loading == true" type="submit" :class="[
                ...
                <router-link :to="{ name: 'app.dashboard' }" class="footer--button--cancel">لغو ثبت</router-link>
            </footer>
        </form>
    </div>
</template>
