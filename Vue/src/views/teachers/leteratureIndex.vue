<template>
    <div class="">
        <div class="flex items-center justify-between mb-8">
            <div>
                <router-link
                    :to="{ name: 'app.teacher.literature.create' }"
                    class="header--button"
                >
                    <svg
            ...
            <div>
                <h1 class="text--header">آثار علمی</h1>
            </div>
        </div>
        ...
        <div class="table--wrapper--dev">
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3"
                        >پیداشد {{ literatures.total }} کابر</span
                    >
                </div>
            </div>
            <table class="table-auto w-full">
                <thead>
                    <tr>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortLiterature('publisher')"
                        >
                            ناشر
                        </TableHeaderCell>
                ...
                <tbody v-if="literatures.loading || !literatures.data?.length">
                    <tr>
                        <td colspan="6">
                            <Spinner v-if="literatures.loading" />
                ...
                <tbody v-else>
                    <tr v-for="(literature, index) of literatures.data">
            ...
            <div
                v-if="!literatures.loading"
                class="flex justify-between items-center mt-5"
                dir="ltr"
            >
                <div v-if="literatures.data">
                    نمایش از {{ literatures.from }} تا {{ literatures.to }}
                </div>
                <nav
                    v-if="literatures.total > literatures.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination"
                >
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a
                        v-for="(link, i) of literatures.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
...
const search = ref("");
const literatures = computed(() => teacherStore.teacher_literature);
...
function getForPage(ev, link) {
    ...
    getLiterature(link.url);
}

function getLiterature(url = null) {
    teacherStore.getLiterature({
        url,
        search: search.value,
...
function deleteLiterature(id) {
    ...
    teacherStore.deleteLiterature(id);
    getLiterature();
}
