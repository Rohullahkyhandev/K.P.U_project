                ...
                <div>
                    <div class="border-b py-2">
                        <h1 class="font-bold text-xl">
                            فورم ویرایش اسناد تحصلی استادان
                        </h1>
                    </div>
                </div>
                <br />
                ...
                <div class="">
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput
                                type="file"
                                @change="(file) => (document.document = file)"
                                class="mb-2"
                            />
                        </div>
                    </div>
...
const document = computed(() => teacherStore.document);

function onSubmit() {
    let id = route.params.d_id;
    let t_id = route.params.id;
    teacherStore.updateDocument(document.value, id, t_id);
}
</script>
