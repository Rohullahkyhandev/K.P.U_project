<template>
    <div class="">
        <div class="flex items-center justify-between mb-8">
            <div>
                <router-link
                    :to="{ name: 'app.teacher.article.create' }"
                    class="header--button"
                >
                    <svg
            ...
            <div>
                <h1 class="text--header">مقالات</h1>
            </div>
        </div>
        ...
        <div class="msg--success" v-if="teacherStore.msg_asuccess">
            <div class="flex items-center justify-between px-10">
                ...
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        @click="teacherStore.msg_asuccess = ''"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke-width="1.5"
                        stroke="currentColor"
        ...
        <div class="table--wrapper--dev">
            <div class="flex justify-between border-b-2 pb-3">
                <div>
                    <input
                        v-model="search"
                        @change="getArticle(null)"
                        class="appearance-none relative block w-48 px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                        placeholder="جستجوی بر اساس نام عنوان"
                    />
                </div>
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3">پیداشد {{ articles.total }} کابر</span>
                </div>
            </div>
            <table class="table-auto w-full">
                ...
                <tbody v-else>
                    <tr v-for="(article, index) of articles.data">
            ...
            >
                <div v-if="articles.data">
                    نمایش از {{ articles.from }} تا {{ articles.to }}
                </div>
                <nav
...
const search = ref("");
const articles = computed(() => teacherStore.teacher_articles);
...
function getArticle(url = null) {
    teacherStore.getArticle({
        url,
        search: search.value,
