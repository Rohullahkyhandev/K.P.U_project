            ...
            <div class="w-full py-8 bg-white shadow mt-8 px-4">
                ...
                <div class="msg--success" v-if="teacherStore.msg_lsuccess">
                    <div class="flex items-center justify-between px-10">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" @click="teacherStore.msg_lsuccess = ''" fill="none"
                ...
                <div class="msg--warning" v-if="teacherStore.msg_lwrang">
                    <div class="flex items-center justify-between px-10">
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" @click="teacherStore.msg_lwrang = ''" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                            </svg>
                        </div>
                ...
                <div class="mt-5">
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput type="text" v-model="literature.name" class="mb-2" required="required" />
                        </div>
                    </div>
                </div>
                ...
                <div class="">
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput type="text" v-model="literature.type" class="mb-2" required="required" />
                        </div>
                    </div>
                </div>
                ...
                <div class="">
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput type="text" v-model="literature.publisher" class="mb-2" required="required" />
                        </div>
                    </div>
                </div>
                ...
                <div class="">
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <DatePicker type="date" v-model="literature.date" class="mb-2" required="required"
