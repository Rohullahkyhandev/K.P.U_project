            ...
            <div class="w-full py-8 bg-white shadow mt-8 px-4">
                ...
                <div>
                    <div class="border-b py-2">
                        <h1 class="font-bold text-xl ">فورم ویرایش اسناد تحصلی استادان</h1>
                    </div>
                </div>
                ...
                <div class="mt-5">
                    <div class="md:flex md:items-center md:justify-center">
                        ...
                        <div class="md:w-6/12">
                            <CustomInput type="text" v-model="teacher_document.type" class="mb-2" required="required" />
                        </div>
                    </div>
                </div>
...
onMounted(() => {
    teacherStore.getDocument(route.params.id);
})
...
function onSubmit() {
    ...
    teacherStore.updateDocument(teacher_document.value, id);
}
