<template>
    <div class="px-5 mt-10">
        <div class="flex items-center justify-between mb-8">
            <div>
                <router-link :to="{ name: 'app.teacher.create' }"
            ...
            <div>
                <h1 class=" font-bold text-xl ">لیست استادان</h1>
            </div>
        </div>

        <div class="bg-white p-6 rounded shadow animate-fade-in-down overflow-auto">
            <!-- display message area -->
            <div class="bg-green-700 text-white rounded py-4 text-center mb-3" v-if="teacherStore.msg_success">
            ...
            <div class="bg-red-500 text-white py-4 rounded text-center mb-3" v-if="teacherStore.msg_wrang">
                <div class="flex items-center justify-between px-10">
                    <div
                                ...
                                <transition enter-active-class="transition duration-100 ease-out"
                                    ...
                                    <MenuItems
                                        ...
                                        <div class="px-1 py-1">
                                            ...
                                            <router-link :to="{ name: 'app.teacher.details', params: { id: teacher.id } }"
                                                :class="[
                                        ...
                                        <div class="px-1 py-1">
                                            <MenuItem v-slot="{ active }">
                                            <router-link :to="{ name: 'app.teacher.edit', params: { id: teacher.id } }"
                                                :class="[
                                                    active ? 'bg-blue-800 text-white' : 'text-gray-900',
                                                    'group flex w-full items-center rounded-md gap-3 px-2 py-2 text-sm',
                                                ]">
                                        ...
                                        <div class="px-1 py-1">
                                            <MenuItem v-slot="{ active }">
                                            <button @click="deleteFaculty(teacher.id)" :class="[
                                                active ? 'bg-blue-800 text-white' : 'text-gray-900',
                                                'group flex w-full items-center rounded-md gap-3 px-2 py-2 text-sm',
                                            ]">
                ...
                <nav v-if="teachers.total > teachers.limit"
                    ...
                    <a v-for="(link, i) of teachers.links" :key="i" :disabled="!link.url" href="#"
                        ...
                        :class="[
                            ...
                            i === 0 ? 'rounded-l-md' : '',
                            i === teachers.links.length - 1 ? 'rounded-r-md' : '',
