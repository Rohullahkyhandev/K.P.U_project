            ...
            <div class="overflow-x-auto">
                <div class="min-w-full shadow rounded-lg overflow-hidden">
                    <div class="table--wrapper--dev min-w-full leading-normal">
                        ...
                        <div
                            class="msg--success"
                            v-if="teacherStore.msg_success"
                        >
                            <div
                                class="flex items-center justify-between px-10 ,mb-3"
                            >
                                <div
                        ...
                        <div class="msg--warning" v-if="teacherStore.msg_wrang">
                            <div
                                class="flex items-center justify-between px-10 mb-10"
                            >
                                <div
                        ...
                        >
                            ...
                            <div class="flex items-center">
                                ...
                                &nbsp;
                                <span class="ml-3"
                                    >پیداشد {{ teachers.total }} دیتا</span
                                >
                            </div>
                        </div>
                        <table class="w-full table-auto border">
                            ...
                            <tbody v-else>
                                <tr
                                    v-for="(teacher, index) of teachers.data"
                                    :key="index"
                                >
