            ...
            <div class="w-full py-8 bg-white shadow mt-8 px-4">
                ...
                <div class="">
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <DatePicker type="text" v-model="article.date" class="mb-2" required="required"
                ...
                <div class="">
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput type="textarea" v-model="article.description" class="mb-2"
                                required="required" />
                        </div>
                    </div>
                </div>
...
function onSubmit() {
    ...
    teacherStore.createArticle(article.value, id);
}
</script>
