              ...
              >
                ...
                >
                  <div class="flex items-center justify-between mb-6">
                    <button class="header--button" @click="toggleModal">
                      <svg
                      ...
                      <span v-if="isOpenList"> ثبت معیار فرعی </span>
                    ...
                    >
                      <span v-if="isOpenForm"> فورم ثبت معیارات فرعی </span>
                      <span v-else> لیست معیارات فرعی </span>
                    </DialogTitle>
                  </div>
                    ...
                    <form @submit.prevent="onSubmit">
                      <div class="">
                        ...
                        <div class="text-right">
                          <span>معیار اصلی شماره :</span>
                          <span>
                            {{
                              subCriteriaStore.criteria.number +
                              "  -" +
                              subCriteriaStore.criteria.year
                            }}
                          </span>
                        </div>
                        <div>
                          <div class="wrapper--dev--input"></div>
                          ...
                          <div class="wrapper--dev--input">
                            ...
                            <div class="input--dev--width">
                              <CustomInput
                                type="textarea"
                                v-model="subCriteria.related_part"
                                class="mb-2"
                                required="required"
                                label=" بخش مربوط"
                              />
                          ...
                          <div class="wrapper--dev--input">
                            ...
                            <div class="input--dev--width">
                              <CustomInput
                                type="file"
                                @change="
                                  (file) => (subCriteria.attachment = file)
                                "
                                class="mb-2"
                                required="required"
                              />
                          ...
                          <div class="wrapper--dev--input">
                            ...
                            <div class="input--dev--width">
                              <CustomInput
                                type="textarea"
                                v-model="subCriteria.description"
                                class="mb-2"
                              />
                            </div>
                          </div>
