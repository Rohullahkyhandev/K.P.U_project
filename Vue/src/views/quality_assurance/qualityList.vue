<template>
    <div class="px-5 mt-10">
        <div class="flex items-center justify-between mb-8">
            ...
            <div>
                <h1 class="font-bold text-xl">
                    لیست پلان هاو اهداف و لاحیه وظایف
                </h1>
            </div>
        </div>
        ...
        <div class="table--wrapper--dev">
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3"
                        >پیداشد {{ archiveStore.total }} دیتا</span
                    >
                </div>
            </div>
            ...
            >
                ...
                <nav
                    v-if="archives.total > archives.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination"
                >
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a
                        v-for="(link, i) of archives.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
        ...
        <!-- create file -->
        <WrapperModal
            :title="'فورم ثبت پلانهاو اهداف و لاحیه وظایف'"
            :is-open="isOpen"
...
import createQualityArchive from "./createArchvie.vue";
