    ...
    <div class="form--padding--top">
        ...
        <div class="table--wrapper--dev">
            ...
            <div
                ...
                v-if="specialAreaStore.msg_wrang"
            >
                <div class="flex items-center justify-between px-10">
                    <div
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3"
                        >پیداشد {{ specialAreas.total }} دیتا</span
                    >
                </div>
            </div>
            ...
            <table class="table-auto w-full border">
                <thead>
                    <tr>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortSpecialArea('related_part')"
                        >
                              بخش فعالیت
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortSpecialArea('related_field')"
                        >
                             رشته مربوطه
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortSpecialArea('acs')"
                        >
                            عملیات
                        </TableHeaderCell>
                    </tr>
                </thead>
                <tbody v-if="specialAreas.loading || !specialAreas.data.length">
                    <tr>
                        <td colspan="10">
                            <Spinner v-if="specialAreas.loading" />
                ...
                <tbody class="border" v-else>
                    <tr
                        v-for="(specialArea, index) of specialAreas.data"
                        :key="index"
                    >
                        <td class="border-b p-3">{{ index + 1 }}</td>

                        <td class="border p-">
                            {{ specialArea.related_part }}
                        </td>
                        <td class="border p-3">
                            {{ specialArea.related_field }}
                        </td>
                        <td class="border p-3">
                            {{ specialArea.uname }}
                        </td>
            ...
            <div
                v-if="!specialAreas.loading"
                class="flex justify-between items-center mt-5"
                dir="ltr"
            >
                <div v-if="specialAreas.data">
                    نمایش از {{ specialAreas.from }} تا {{ specialAreas.to }}
                </div>
                <nav
                    v-if="specialAreas.total > specialAreas.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination"
                >
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a
                        v-for="(link, i) of specialAreas.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
...
const search = ref("");
const specialAreas = computed(() => specialAreaStore.specialAreas);
...
function getForPage(ev, link) {
    ...
    getSpecialArea(link.url);
}

function getSpecialArea(url = null) {
...
function sortSpecialArea(field) {
...
function deleteSpecialArea(id) {
    ...
    specialAreaStore.deleteSpecialArea(id);
    if (specialAreaStore.msg_success != null) {
    }
    getSpecialArea();
}
