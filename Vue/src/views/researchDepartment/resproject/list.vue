                            ...
                            <thead>
                                <tr>
                                    ...
                                    <TableHeaderCell
                                        ...
                                        :sortField="sortField"
                                        @click="
                                            sortResProject('scope_of_project')
                                        "
                                    >
                                        وسعت پروژه
                                    </TableHeaderCell>
