    ...
    <div class="form--padding--top">
        ...
        <div class="table--wrapper--dev">
            ...
            <div
                ...
                v-if="interpubStore.msg_success"
            >
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3"
                        >پیداشد {{ publishments.total }} دیتا</span
                    >
                </div>
            </div>
            ...
            <table class="table-auto w-full border">
                <thead>
                    <tr>
                        ...
                        <TableHeaderCell
                            field="author_assesstance"
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortPublishment('author_assesstance')"
                        >
                            همکار نویسنده
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            field="journal_link_website"
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortPublishment('journal_link_website')"
                        >
                            لینک جورنال
                        </TableHeaderCell>
                        <TableHeaderCell
                ...
                <tbody class="border" v-else>
                    <tr
                        v-for="(publishment, index) of publishments.data"
                        :key="index"
                    >
            ...
            >
                ...
                <nav
                    v-if="publishments.total > publishments.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination"
                >
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a
                        v-for="(link, i) of publishments.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
