    ...
    <div class="form--padding--top">
        ...
        <div class="table--wrapper--dev">
            ...
            <div
                ...
                v-if="teacherResearchStore.msg_wrang"
            >
                <div class="flex items-center justify-between px-10">
                    <div
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3"
                        >پیداشد {{ teacherResearchs.total }} دیتا</span
                    >
                </div>
            </div>
            ...
            <table class="table-auto w-full border">
                <thead>
                    <tr>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortTeacherResearch('name')"
                        >
                            اســـــم استاد
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortTeacherResearch('lname')"
                        >
                            تخلص استاد
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortTeacherResearch('academic_rank')"
                        >
                            رتبه علمی
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortTeacherResearch('education_degree')"
                        >
                            سطح تحصیلی
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortTeacherResearch('research_title')"
                        >
                            عنوان تحقیق
                        </TableHeaderCell>
                ...
                <tbody class="border" v-else>
                    ...
                    >
                        ...
                        <td class="border p-">
                            {{ teacherResearch.name }}
                        </td>
                        <td class="border p-3">
                            {{ teacherResearch.lname }}
                        </td>
                        <td class="border p-3">
                            {{ teacherResearch.fname }}
                        </td>

                        <td class="border p-3">
                            {{ teacherResearch.academic_rank }}
                        </td>
            ...
            >
                ...
                >
                    ...
                    <a
                        v-for="(link, i) of teacherResearchs.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
                        ...
                        :class="[
                            ...
                            i === 0 ? 'rounded-l-md' : '',
                            i === teacherResearchs.links.length - 1
                                ? 'rounded-r-md'
                                : '',
...
function getForPage(ev, link) {
    ...
    getTeacherResearch(link.url);
}

function getTeacherResearch(url = null) {
...
function sortTeacherResearch(field) {
...
function deleteTeacherResearch(id) {
    ...
    teacherResearchStore.deleteTeacherResearch(id);
    if (teacherResearchStore.msg_success != null) {
    }
    getTeacherResearch();
}
