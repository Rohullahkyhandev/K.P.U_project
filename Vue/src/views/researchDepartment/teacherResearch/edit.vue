    ...
    <div class="form--padding--top">
        <div class="flex items-center justify-between w-full">
            <div>
                ...
                >
                    ...
                    لیست تخقیقات استادان 
                </router-link>
            </div>
            <div>
                <h1 class="text--header">فورم ثبت تخقبق جدید</h1>
            </div>
        </div>
        ...
        <form @submit.prevent="onSubmit">
            <div class="bg-white p-8 mt-6">
                ...
                <div class="msg--success" v-if="teacherResearchStore.msg_success">
                ...
                <div class="wrapper--dev--input">
                    <div class="label--dev--width">
                        <label for="" class="form--label">
                            اســـــم  استاد<span class="label--prefix">*</span></label
                        >
                    </div>
                ...
                <div class="wrapper--dev--input">
                    <div class="label--dev--width">
                        <label for="" class="form--label">
                            تخلص استاد<span class="label--prefix">*</span></label
                        >
                    </div>
                    <div class="input--dev--width">
                        <CustomInput
                ...
                <div>
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <select
                                v-model="teacherResearch.departments"
                                multiple
...
const departments = computed(() => teacherResearchStore.listDepartments);
