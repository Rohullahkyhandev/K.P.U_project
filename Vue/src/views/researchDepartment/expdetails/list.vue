    ...
    <div class="form--padding--top">
        ...
        <div class="table--wrapper--dev">
            ...
            <div
                ...
                v-if="expDetailStore.msg_success"
            >
            ...
            <table class="table-auto w-full border">
                <thead>
                    <tr>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortExpDetail('acs')"
                        >
                            عملیات
                        </TableHeaderCell>
                    </tr>
                </thead>
                <tbody v-if="expDetails.loading || !expDetails.data.length">
                    <tr>
                        <td colspan="10">
                            <Spinner v-if="expDetails.loading" />
                ...
                <tbody class="border" v-else>
                    <tr
                        v-for="(expDetail, index) of expDetails.data"
                        :key="index"
                    >
            ...
            <div
                v-if="!expDetails.loading"
                class="flex justify-between items-center mt-5"
                dir="ltr"
            >
                <div v-if="expDetails.data">
                    نمایش از {{ expDetails.from }} تا {{ expDetails.to }}
                </div>
                <nav
                    v-if="expDetails.total > expDetails.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination"
                >
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a
                        v-for="(link, i) of expDetails.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
...
const search = ref("");
const expDetails = computed(() => expDetailStore.expDetails);
...
function getForPage(ev, link) {
    ...
    getExpDetail(link.url);
}

function getExpDetail(url = null) {
