<template>
    <div class="form--padding--top">
        <div class="flex items-center justify-between w-full">
            ...
            <div>
                <h1 class="text--header">فورم ویرایش کمیته</h1>
            </div>
        </div>
            ...
            <div class="wrapper--dev--form">
                ...
                <div>
                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label for="" class="form--label">
                                نام کمیته<span class="label--prefix"
                                    >*</span
                                ></label
                            >
                        </div>
                    ...
                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label for="" class="form--label"
                                >موضوع کمیته<span class="label--prefix"
                                    >*</span
                                ></label
                            >
                        </div>
                    ...
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput
                                type="file"
                                @change="(file) => (commit.attachment = file)"
                                class="mb-2"
                            />
                        </div>
                    </div>
...
onMounted(() => {
    commitStore.editCommit(route.params.id);
});

const commit = computed(() => commitStore.commit);

function onSubmit() {
    commitStore.updateCommit(commit.value);
}
</script>
