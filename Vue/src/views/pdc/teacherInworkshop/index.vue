    ...
    <div class="form--padding--top">
        <div class="flex items-center justify-between mb-4">
            <div class="mb-2 flex gap-4">
                <router-link
                    :to="{ name: 'app.pdc.teacher_in_workshop.create' }"
                    class="header--button"
                >
                    <svg
            ...
            <div class="text--header">لسیت استادان در ورکشاپ ها</div>
        </div>
        ...
        <div class="table--wrapper--dev">
            ...
            >
                <div class="flex items-center justify-between px-10">
                    ...
                    <div>
                        <span>{{ teacherInWorkshopStore.msg_success }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3"
                        >پیداشد {{ teacherInworkshops.total }} دیتا</span
                    >
                </div>
            </div>
            ...
            <table class="table-auto w-full border">
                <thead>
                    <tr>
                        <TableHeaderCell
                            ...
                            :sortField="sortField"
                            @click="sortTeacherInWorkshop('id')"
                        >
                            شماره.
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortTeacherInWorkshop('topic')"
                        >
                            نام
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortTeacherInWorkshop('end_time')"
                        >
                            ورکشاپ
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortTeacherInWorkshop('document')"
                        >
                            فایل
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortTeacherInWorkshop('acs')"
                        >
                            عملیات
                        </TableHeaderCell>
                    </tr>
                ...
                <tbody
                    v-if="
                        teacherInworkshops.loading ||
                        !teacherInworkshops.data.length
                    "
                >
                    <tr>
                        <td colspan="10">
                            <Spinner v-if="teacherInworkshops.loading" />
                ...
                <tbody class="border" v-else>
                    <tr
                        v-for="(workshop, index) of teacherInworkshops.data"
                        :key="index"
                    >
            ...
            <div
                v-if="!teacherInworkshops.loading"
                class="flex justify-between items-center mt-5"
                dir="ltr"
            >
                <div v-if="teacherInworkshops.data">
                    نمایش از {{ teacherInworkshops.from }} تا
                    {{ teacherInworkshops.to }}
                </div>
                <nav
                    v-if="teacherInworkshops.total > teacherInworkshops.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination"
                >
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a
                        v-for="(link, i) of teacherInworkshops.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
                        ...
                        :class="[
                            ...
                            i === 0 ? 'rounded-l-md' : '',
                            i === teacherInworkshops.links.length - 1
                                ? 'rounded-r-md'
                                : '',
...
const search = ref("");
const teacherInworkshops = computed(
    () => teacherInWorkshopStore.teacherInWorkshops
);
...
function getForPage(ev, link) {
    ...
    getTeacherInWorkshop(link.url);
}

function getTeacherInWorkshop(url = null) {
    teacherInWorkshopStore.getTeacherInWorkshop({
        url,
        search: search.value,
...
function sortTeacherInWorkshop(field) {
...
function deleteTeacherInWorkshop(id) {
    ...
    if (teacherInWorkshopStore.msg_success != null) {
    }
    getTeacherInWorkshop();
}
