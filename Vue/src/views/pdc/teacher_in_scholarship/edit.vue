<template>
    <div class="form--padding--top">
        <div class="flex items-center justify-between w-full">
            <div>
                <router-link :to="{ name: 'app.pdc.teacher_in_scholarship.list' }" class="header--button">
        ...
        <form @submit.prevent="onSubmit">
            <div class="wrapper--dev--form">
                ...
                <div class="msg--success" v-if="teacherInScholarshipStore.msg_success">
                ...
                <div class="msg--wrang" v-if="teacherInScholarshipStore.msg_wrang">
                    <div class="flex items-center justify-between px-10">
                        <div
                ...
                <div class="mt-5">
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput type="text" v-model="teacherInScholarship.country_name" class="mb-2"
                                required="required" label="کشور" />
                        </div>
                    </div>
                </div>
                ...
                <div class="wrapper--dev--input">
                    <div class="label--dev--width">
                        <label class="form--label">ریشته تحصیلی
                            <span class="label--prefix">*</span>
                        </label>
                    </div>
                    <div class="input--dev--width">
                        <CustomInput type="text" v-model="teacherInScholarship.edu_degree" class="mb-2"
                            required="required" label="ریشته تحصیلی" />
                    </div>
                </div>
                ...
                <div class="wrapper--dev--input">
                    ...
                    <div class="w-6/12">
                        <CustomInput type="select" :select-options="degree_types"
                            v-model="teacherInScholarship.edu_maqta" class="mb-2" required="required"
                            label="مقطع تحصیلی" />
                    </div>
                </div>
                ...
                <div class="wrapper--dev--input">
                    ...
                    <div class="w-6/12">
                        <DatePicker v-model="teacherInScholarship.sent_date" class="mb-2" required="required"
                ...
                <div class="wrapper--dev--input">
                    <div class="w-2/12">
                        <label class="form--label">تاریخ برگشت
                            <span class="label--prefix">*</span>
                        </label>
                    </div>
                    <div class="w-6/12">
                        <DatePicker v-model="teacherInScholarship.back_date" class="mb-2" required="required"
                ...
                <div class="wrapper--dev--input">
                    ...
                    <div class="input--dev--width">
                        <CustomInput type="select" @change="
                            getDepartment(teacherInScholarship.faculty_id)
                            " :selectOptions="faculties" v-model="teacherInScholarship.faculty_id" class="mb-2"
                            label="پوهنځی" />
                    </div>
                </div>
                ...
                <div class="wrapper--dev--input" v-if="departments.length > 0">
                    ...
                    <div class="w-6/12">
                        <CustomInput type="select" @change="
                            ...
                            " v-model="teacherInScholarship.department_id" :selectOptions="departments" class="mb-2"
                            required="required" label=" دیپارتمنت" />
                    </div>
                </div>
                <div class="wrapper--dev--input" v-if="teacherInScholarship.faculty_id == ''">
                    <div class="w-2/12">
                    ...
                    <div class="w-6/12">
                        <CustomInput type="select" @change="
                            ...
                            :selectOptions="departments_out_of_faculties" class="mb-2" required="required"
                            label=" دیپارتمنت" />
                    </div>
                </div>

                <div class="wrapper--dev--input" v-if="teacherInScholarship.department_id != ''">
                    <div class="label--dev--width">
                        <label class="form--label">استادان
                            <span class="label--prefix">*</span>
                        </label>
                    </div>
                    <div class="input--dev--width">
                        <CustomInput type="select" v-model="teacherInScholarship.teacher_id" :select-options="teachers"
                            class="mb-2" required="required" label=" استاد" />
                    </div>
                </div>
                <div class="wrapper--dev--input">
                    <div class="label--dev--width">
                        <label class="form--label">آپلود اسناد
                            <span class="label--prefix"></span>
                        </label>
                    </div>
                    <div class="w-6/12">
                        <CustomInput type="file" @change="
                                (file) => (teacherInScholarship.document = file)
                            " class="mb-2" label=" اسناد" />
                    </div>
                </div>
            </div>
            <footer class="bg-gray-100 py-4 md:flex gap-5">
                ...
                <router-link :to="{ name: 'app.pdc.teacher_in_scholarship.list' }"
