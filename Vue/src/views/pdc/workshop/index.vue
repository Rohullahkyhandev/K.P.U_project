<template>
    <div class="form--padding--top">
        ...
        <div
            class="bg-white p-6 rounded shadow animate-fade-in-down overflow-auto w-full"
        >
            <!-- display message area -->
            <div
                class="bg-green-700 text-white rounded py-4 mb-2 text-center"
                v-if="workshopStore.msg_success"
            >
                <div class="flex items-center justify-between px-10">
                    ...
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            @click="workshopStore.msg_success = ''"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke-width="1.5"
                            stroke="currentColor"
                    ...
                    <div>
                        <span>{{ workshopStore.msg_success }}</span>
                    </div>
                </div>
            </div>
            ...
            >
                <div class="flex items-center justify-between px-10">
                    ...
                    <div>
                        <span>{{ workshopStore.msg_wrang }}</span>
                    </div>
                </div>
            </div>
            ...
            <table class="table-auto w-full border">
                ...
                <tbody v-if="workshops.loading || !workshops.data.length">
                    <tr>
                        <td colspan="10">
                            <Spinner v-if="workshops.loading" />
                ...
                <tbody class="border" v-else>
                    <tr
                        v-for="(workshop, index) of workshops.data"
                        :key="index"
                    >
            ...
            <div
                v-if="!workshops.loading"
                class="flex justify-between items-center mt-5"
                dir="ltr"
            >
                <div v-if="workshops.data">
                    نمایش از {{ workshops.from }} تا {{ workshops.to }}
                </div>
                <nav
                    v-if="workshops.total > workshops.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination"
                >
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a
                        v-for="(link, i) of workshops.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
...
import useWorkShopStore from "../../../stores/pdc/workshop/workshopStore";
...
function getForPage(ev, link) {
    ...
    getWorkshop(link.url);
}

function getWorkshop(url = null) {
...
function deleteWorkshop(id) {
    ...
    if (workshopStore.msg_success != null) {
    }
    getWorkshop();
}
