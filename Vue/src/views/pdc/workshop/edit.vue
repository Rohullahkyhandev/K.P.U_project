<template>
    <div class="form--padding--top">
        <div class="flex items-center justify-between w-full">
            ...
            <div>
                <h1 class="text--header">فورم ویرایش ورکشاپ</h1>
            </div>
        </div>
        <form @submit.prevent="onSubmit" enctype="multipart/form-data">
            <div class="wrapper--dev--form">
                ...
                <div class="msg--warning" v-if="workshopStore.msg_wrang">
                    <div class="flex items-center justify-between px-10">
                        <div
...
onMounted(() => {
    workshopStore.editWorkshop(route.params.id);
});

function onSubmit() {
    let id = route.params.id;
    workshopStore.updateWorkshop(workshop.value, id);
}
</script>
