<template>
    <div class="mt-10 mb-10 w-full">
        <div class="flex items-center justify-between w-full">
            ...
            <div>
                <h1 class="font-bold text-xl">فورم ویرایش مکتوب وارده</h1>
            </div>
        </div>
        ...
        <form @submit.prevent="onSubmit">
            <div class="w-full py-8 bg-white shadow mt-8 px-4">
                ...
                <div class="mt-5">
                    <div class="md:flex items-center justify-center">
                        ...
                        <div class="w-6/12">
                            <CustomInput type="text" v-model="ReceiveDocument.source" class="mb-2" required="required" />
                        </div>
                    </div>
                    ...
                    <div class="md:flex items-center justify-center">
                        ...
                        <div class="w-6/12">
                            <CustomInput type="text" v-model="ReceiveDocument.destination" class="mb-2"
                                required="required" />
                        </div>
                    </div>
                    ...
                    <div class="md:flex items-center justify-center">
                        ...
                        <div class="w-6/12">
                            <CustomInput type="text" v-model="ReceiveDocument.iqdam_no" class="mb-2" required="required" />
                        </div>
                    </div>
                    ...
                    <div class="md:flex items-center justify-center">
                        ...
                        <div class="w-6/12">
                            <CustomInput type="text" v-model="ReceiveDocument.pages_no" class="mb-2" required="required" />
                        </div>
                    </div>
                    ...
                    <div class="md:flex items-center justify-center">
                        ...
                        <div class="w-6/12">
                            <CustomInput type="text" v-model="ReceiveDocument.volume" class="mb-2" required="required" />
                        </div>
                    </div>
                    ...
                    <div class="md:flex items-center justify-center">
                        ...
                        <div class="w-6/12">
                            <CustomInput type="text" v-model="ReceiveDocument.entered_no" class="mb-2"
                                required="required" />
                        </div>
                    </div>
                    ...
                    <div class="md:flex items-center justify-center">
                        ...
                        <div class="w-6/12">
                            <CustomInput type="date" v-model="ReceiveDocument.date_of_entered" class="mb-2"
                                required="required" />
                        </div>
                    </div>
                    ...
                    <div class="md:flex items-center justify-center">
                        ...
                        <div class="w-6/12">
                            <CustomInput type="date" v-model="ReceiveDocument.document_date" class="mb-2"
                                required="required" />
                        </div>
                    </div>
                    ...
                    <div class="md:flex items-center justify-center">
                        ...
                        <div class="w-6/12">
                            <CustomInput type="file" class="mb-2" @change="file => ReceiveDocument.attachment = file"
                                required="required" />
                        </div>
                    </div>
                    ...
                    <div class="md:flex items-center justify-center">
                        ...
                        <div class="w-6/12">
                            <CustomInput type="textarea" v-model="ReceiveDocument.description" class="mb-2 " />
                        </div>
                    </div>
                    ...
                    <div class="md:flex items-center justify-center">
                        ...
                        <div class="w-6/12">
                            <CustomInput type="textarea" v-model="ReceiveDocument.remark" class="mb-2" />
                        </div>
                    </div>
            ...
            <footer class="bg-gray-100 py-4  md:flex gap-5">
                <button type="submit"
                    :class="[receivedDocumentStore.loading === true ? 'bg-green-600 mr-10 text-white py-2 px-6 cursor-not-allowed rounded focus:ring focus:ring-green-500' : 'bg-green-600 mr-10 text-white py-2 px-6 cursor-pointer rounded focus:ring focus:ring-green-500']">
...
const ReceiveDocument = computed(() => receivedDocumentStore.receivedDocument);
const route = useRoute();

onMounted(() => {
    getReceivedDocument(route.params.id);
})
// const user_type = ref([
//     { key: 'pdc', text: 'PDC' },
...
function getReceivedDocument(id) {
    receivedDocumentStore.editReceivedDocument(id);
}


function onSubmit() {
    receivedDocumentStore.UpdateReceivedDocument(ReceiveDocument.value);
