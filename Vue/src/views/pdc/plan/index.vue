<template>
    <div class=" mt-8">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="font-bold text-xl">لسیت پلان ها
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded shadow animate-fade-in-down overflow-auto w-full">
            ...
            <div class="bg-green-700 text-white rounded py-4 mb-2 text-center" v-if="planStore.msg_success">
            ...
            <div class="bg-red-500 text-white py-4 rounded mb-2 text-center" v-if="planStore.msg_wrang">
                <div class="flex items-center justify-between px-10">
                    <div
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div>
                    <input v-model="search" @change="getPlan(null)"
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <select @change="getPlan(null)" v-model="perPage" dir="ltr"
                    ...
                    &nbsp;
                    <span class="ml-3">پیداشد {{ plans.total }} پلان</span>
                </div>
            </div>
            ...
            <table class="table-auto w-full border">
                ...
                <tbody v-if="plans.loading || !plans.data.length">
                    <tr>
                        <td colspan="10">
                            <Spinner v-if="plans.loading" />
                                ...
                                <transition enter-active-class="transition duration-100 ease-out"
                                    ...
                                    <MenuItems
                                        ...
                                        <div class="px-1 py-1">
                                            ...
                                            <router-link :to="{ name: 'app.pdc.plan.edit', params: { id: plan.id } }"
                                                :class="[
                                        ...
                                        <div class="px-1 py-1">
                                            <MenuItem v-slot="{ active }">
                                            <button @click="deletePlan(plan.id)" :to="{ name: 'app.pdc.received_document' }"
                                                :class="[
                                                    active ? 'bg-blue-800 text-white' : 'text-gray-900',
                                                    'group flex w-full items-center rounded-md gap-3 px-2 py-2 text-sm',
                                                ]
            ...
            <div v-if="!plans.loading" class="flex justify-between items-center mt-5" dir="ltr">
                <div v-if="plans.data">
                    نمایش از {{ plans.from }} تا {{ plans.to }}
                </div>
                <nav v-if="plans.total > plans.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination">
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a v-for="(  link, i  ) of   plans.links  " :key="i" :disabled="!link.url" href="#"
                        ...
                        :class="[
                            ...
                            i === 0 ? 'rounded-l-md' : '',
                            i === plans.links.length - 1 ? 'rounded-r-md' : '',
