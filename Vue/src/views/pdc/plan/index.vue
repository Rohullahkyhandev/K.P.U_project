<template>
    <div class="form--padding--top">
        <div class="flex items-center justify-between mb-4 sm:px-10">
            <div class="mb-2">
                <router-link
                    :to="{ name: 'app.pdc.plan.create' }"
                    class="header--button"
                >
                    <svg
            ...
            <div class="text--header">لسیت پلان ها</div>
        </div>
        <div class="container mx-auto sm:px-8 max-w-7xl">
                    ...
                    <div class="table--wrapper--dev leading-normal">
                        ...
                        <table class="table-auto w-full border">
                            ...
                            <tbody class="border" v-else>
                                <tr
                                    v-for="(plan, index) of plans.data"
                                    :key="index"
                                >
                        ...
                        >
                            ...
                            <nav
                                v-if="plans.total > plans.limit"
                                class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                                aria-label="Pagination"
                            >
                                <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                                <a
                                    v-for="(link, i) of plans.links"
                                    :key="i"
                                    :disabled="!link.url"
                                    href="#"
