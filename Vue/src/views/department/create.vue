        ...
        <form @submit.prevent="onSubmit" enctype="multipart/form-data">
            <div class="w-full py-8 bg-white shadow mt-8 px-4">
                ...
                <div
                    ...
                    v-if="departmentStore.msg_success"
                >
                    <div class="flex items-center justify-between px-10">
                        ...
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                @click="departmentStore.msg_success = ''"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke-width="1.5"
                                stroke="currentColor"
                ...
                <div
                    ...
                    v-if="departmentStore.msg_wrang"
                >
                    <div class="flex items-center justify-between px-10">
                        <div
                        ...
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                @click="departmentStore.msg_wrang = ''"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke-width="1.5"
                                stroke="currentColor"
                ...
                <div>
                    <div class="border-b py-2">
                        <h1 class="text--header">فورم ثبت اطلاعات دیپارتمنت</h1>
                    </div>
                </div>
                <div class="mt-5">
                    ...
                    <div class="wrapper--dev--input">
                        <div class="label--dev--width">
                            <label class="form--label"
                                >تاریخ تاسیس دیپارتمنت
                                <span class="label--prefix">*</span>
                            </label>
                        </div>
                        <div class="input--dev--width">
                            <DatePicker
                                v-model="department.date"
                                class="mb-2"
                                required="required"
                    ...
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput
                                type="text"
                                v-model="department.manager_name"
                                class="mb-2"
                                required="required"
                            />
                        </div>
                    ...
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput
                                type="text"
                                v-model="department.manager_lname"
                                class="mb-2"
                                required="required"
                            />
                        </div>
                    ...
                    <div class="wrapper--dev--input">
                        ...
                        <div class="input--dev--width">
                            <CustomInput
                                type="file"
                                @change="(file) => (department.photo = file)"
                                class="mb-2"
                            />
                        </div>
                    </div>
...
function onSubmit() {
    departmentStore.createDepartment(department.value);
}
</script>
