    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
                ...
                <div>
                    <div class="text-lg font-bold">تعداد نشرات</div>
            ...
            >
                ...
                <div>
                    <div class="text-lg font-bold">تعداد لابراتوار ها</div>
                    <div class="text-2xl font-bold">
                        {{ total_lab }}
                    </div>
                </div>
            ...
            >
                ...
                <div>
                    <div class="text-lg font-bold">تعداد پروژه های تحقیق</div>
                    <div class="text-2xl font-bold">
                        {{ total_res_project }}
                    </div>
                </div>
...
let totalـpublishment = ref("");
let total_lab = ref("");
let total_res_project = ref("");
...
const getTotalData = async () => {
    try {
        const response = await axiosClient.get(
            "/research_department/report/total"
        );
        totalـpublishment.value = response.data.totalـpublishment;
        total_lab.value = response.data.total_lab;
        total_res_project.value = response.data.total_res_project;
