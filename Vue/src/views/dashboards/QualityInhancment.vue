    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
                ...
                <div>
                    <div class="text-lg font-bold">تعداد معیار های اصلی</div>
            ...
            >
                ...
                <div>
                    <div class="text-lg font-bold">تعداد معیار های فرعی </div>
                    <div class="text-2xl font-bold">
                        {{ total_subCriteria }}
                    </div>
                </div>
...
let total_mainCriteria = ref("");
let total_subCriteria = ref("");
...
const getTotalData = async () => {
    try {
        ...
        total_mainCriteria.value = response.data.total_mainCriteria;
        total_subCriteria.value = response.data.total_subCriteria;
