<template>
    <div class="form--padding--top">
        <div class="flex items-center justify-between mb-4">
            <div class="mb-2">
                <router-link
                    :to="{ name: 'app.post-graduated.commit.create' }"
                    class="header--button"
                >
                    <svg
        ...
        <div class="table--wrapper--dev">
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3">پیداشد {{ commits.total }} دیتا</span>
                </div>
            </div>
            ...
            <table class="table-auto w-full border">
                <thead>
                    <tr>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortCommit('director_phone')"
                        >
                            شماره تماس ریس
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortCommit('secretary_phone')"
                        >
                            شماره تماس سکرتر
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortCommit('metting_per_month')"
                        >
                            تعداد جلسات هر ماه
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortCommit('metting_place')"
                        >
                            محل جلسات
                        </TableHeaderCell>
                ...
                <tbody class="border" v-else>
                    <tr v-for="(commit, index) of commits.data" :key="index">
                        ...
                        <td class="border p-3">
                            {{ commit.director_phone }}
                        </td>

                        <td class="border p-3">
                            {{ commit.secretary_phone }}
                        </td>

                        <td class="border p-3">
                            {{ commit.metting_per_month }}
                        </td>

                        <td class="border p-3">
                            {{ commit.metting_place }}
                        </td>
...
import CommitMemberList from "../commitMember/index.vue";
