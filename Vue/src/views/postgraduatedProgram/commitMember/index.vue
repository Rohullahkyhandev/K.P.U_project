<template>
    <div class="form--padding--top">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="text--header">لیست اعضای کمیته ها</div>
        </div>
        ...
        <div class="table--wrapper--dev">
            ...
            <div
                ...
                v-if="commitMemberStore.msg_success"
            >
            ...
            <div
                ...
                v-if="commitMemberStore.msg_wrang"
            >
                <div class="flex items-center justify-between px-10">
                    <div
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3"
                        >پیداشد {{ commitMembers.total }} دیتا</span
                    >
                </div>
            </div>
            ...
            <table class="table-auto w-full border">
                <thead>
                    <tr>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortCommitMember('address')"
                        >
                            آدرس
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortCommitMember('faculty')"
                        >
                            دانشکده
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortCommitMember('commit_id')"
                        >
                            کمیته مربوطه
                        </TableHeaderCell>
                ...
                <tbody
                    v-if="commitMembers.loading || !commitMembers.data.length"
                >
                    <tr>
                        <td colspan="10">
                            <Spinner v-if="commitMembers.loading" />
                ...
                <tbody class="border" v-else>
                    <tr
                        v-for="(commit, index) of commitMembers.data"
                        :key="index"
                    >
            ...
            <div
                v-if="!commitMembers.loading"
                class="flex justify-between items-center mt-5"
                dir="ltr"
            >
                <div v-if="commitMembers.data">
                    نمایش از {{ commitMembers.from }} تا {{ commitMembers.to }}
                </div>
                <nav
                    v-if="commitMembers.total > commitMembers.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination"
                >
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a
                        v-for="(link, i) of commitMembers.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
                        ...
                        :class="[
                            ...
                            i === 0 ? 'rounded-l-md' : '',
                            i === commitMembers.links.length - 1
                                ? 'rounded-r-md'
                                : '',
...
import createCommitMember from "../commitMember/create.vue";
...
const search = ref("");
const commitMembers = computed(() => commitMemberStore.commitMembers);
...
// modal
const title = ref("فورم ثبت اطلاعات");
...
function getForPage(ev, link) {
    ...
    getCommitMember(link.url);
}

function getCommitMember(url = null) {
...
function sortCommitMember(field) {
...
function deleteCommitMember(id) {
    ...
    commitMemberStore.deleteCommitMember(id);
    if (commitMemberStore.msg_success != null) {
    }
    getCommitMember();
}
