<template>
    <div class="form--padding--top mt-0">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="text--header">فورم ویرایش صنف</div>
        </div>
            ...
            <div class="wrapper--dev--form">
                ...
                <div class="wrapper--dev--input">
                    ...
                    <div class="input--dev--width">
                        <CustomInput
                            type="text"
                            v-model="classRoom.max_quantity"
                            class="mb-2"
                            required="required"
                        />
                    </div>
...
onMounted(() => {
    ...
    classRoomStore.editClassRoom(route.params.id);
});
...
function onSubmit() {
    classRoomStore.updateClassRoom(classRoom.value);
}
</script>
