<template>
    <div class="form--padding--top">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="text--header">لیست صنف ها</div>
        </div>
        ...
        <div class="table--wrapper--dev">
            ...
            <div
                ...
                v-if="classRoomStore.msg_success"
            >
                <div class="flex items-center justify-between px-10">
                    ...
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            @click="classRoomStore.msg_success = ''"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke-width="1.5"
                            stroke="currentColor"
            ...
            >
                <div class="flex items-center justify-between px-10">
                    ...
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            @click="classRoomStore.msg_wrang = ''"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke-width="1.5"
                            stroke="currentColor"
            ...
            <div class="flex justify-between border-b-2 pb-3">
                <div>
                    <input
                        ...
                        placeholder="جستجوی بر اساس نمر صنف"
                    />
                </div>
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3">پیداشد {{ classRooms.total }} دیتا</span>
                </div>
            </div>
            ...
            <table class="table-auto w-full border">
                <thead>
                    <tr>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortClassRoom('max_quantity')"
                        >
                            حد اکثر ظرفیت صنف
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortClassRoom('acs')"
                        >
                            عملیات
                        </TableHeaderCell>
                    </tr>
                </thead>
                <tbody v-if="classRooms.loading || !classRooms.data.length">
                    <tr>
                        <td colspan="10">
                            <Spinner v-if="classRooms.loading" />
                ...
                <tbody class="border" v-else>
                    <tr
                        v-for="(classRoom, index) of classRooms.data"
                        :key="index"
                    >
            ...
            <div
                v-if="!classRooms.loading"
                class="flex justify-between items-center mt-5"
                dir="ltr"
            >
                <div v-if="classRooms.data">
                    نمایش از {{ classRooms.from }} تا {{ classRooms.to }}
                </div>
                <nav
                    v-if="classRooms.total > classRooms.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination"
                >
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a
                        v-for="(link, i) of classRooms.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
...
import createClassRoom from "./create.vue";
...
function getForPage(ev, link) {
    ...
    getClassRoom(link.url);
}

function getClassRoom(url = null) {
...
function deleteClassRoom(id) {
    if (!confirm(`آیا شما مطمین هستید که این دیتا را حذف می نماید?`)) {
        return;
    }
    classRoomStore.deleteClassRoom(id);
    if (classRoomStore.msg_success != null) {
    }
    getClassRoom();
}
