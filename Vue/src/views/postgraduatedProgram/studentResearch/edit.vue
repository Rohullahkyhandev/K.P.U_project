<template>
    <div class="form--padding--top">
        <div class="flex items-center justify-between w-full">
            ...
            <div>
                <h1 class="text--header">فورم ویرایش تحقیقات محصلین</h1>
            </div>
        </div>
        ...
        <form @submit.prevent="onSubmit">
            <div class="w-full py-8 bg-white shadow mt-8 px-4">
                ...
                <div class="wrapper--dev--input" v-if="teachers">
                    <div class="label--dev--width">
                        <label class="form--label"
                            >استاد رهنما
                            <span class="label--prefix">*</span>
...
onMounted(() => {
    ...
    studentResearchStore.editStudentResearch(route.params.id);
...
setTimeout(() => {
    getTeachers(studentResearch.value.program_id);
}, 2000);
...
function onSubmit() {
    ...
    studentResearchStore.updateStudentResearch(studentResearch.value, id);
}
</script>
