    ...
    <div class="mt-10">
        <div class="flex items-center justify-between mb-4">
            <div class="mb-2">
                <button @click="openModal" class="header--button">
                    ...
                    ثبت وسایل جدید لابرتوار
                </button>
            </div>

            <div class="text--header">لیست تجهیزات لابرتوار ها</div>
        </div>
        ...
        <div class="table--wrapper--dev">
            ...
            <div
                ...
                v-if="labEquipmentStore.msg_success"
            >
            ...
            <div
                ...
                v-if="labEquipmentStore.msg_wrang"
            >
                <div class="flex items-center justify-between px-10">
                    <div
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3"
                        >پیداشد {{ lab_equipments.total }} دیتا</span
                    >
                </div>
            </div>
            ...
            <table class="table-auto w-full border">
                ...
                <tbody
                    v-if="lab_equipments.loading || !lab_equipments.data.length"
                >
                    <tr>
                        <td colspan="10">
                            <Spinner v-if="lab_equipments.loading" />
                ...
                <tbody class="border" v-else>
                    <tr
                        v-for="(equipment, index) of lab_equipments.data"
                        :key="index"
                    >
            ...
            <div
                v-if="!lab_equipments.loading"
                class="flex justify-between items-center mt-5"
                dir="ltr"
            >
                <div v-if="lab_equipments.data">
                    نمایش از {{ lab_equipments.from }} تا
                    {{ lab_equipments.to }}
                </div>
                <nav
                    v-if="lab_equipments.total > lab_equipments.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination"
                >
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a
                        v-for="(link, i) of lab_equipments.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
                        ...
                        :class="[
                            ...
                            i === 0 ? 'rounded-l-md' : '',
                            i === lab_equipments.links.length - 1
                                ? 'rounded-r-md'
                                : '',
...
import createLabTools from "./create.vue";
...
const search = ref("");
const lab_equipments = computed(() => labEquipmentStore.lab_equipments);
...
function getForPage(ev, link) {
    ...
    getLabEquipment(link.url);
}

function getLabEquipment(url = null) {
...
function deleteLabEquipment(id) {
    ...
    labEquipmentStore.deleteEquipment(id);
    if (labEquipmentStore.msg_success != null) {
    }
    getLabEquipment();
}
