<template>
    <div class="form--padding--top">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="text--header">لسیت بورد ها</div>
        </div>
        ...
        <div class="table--wrapper--dev">
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3">پیداشد {{ boards.total }} دیتا</span>
                </div>
            </div>
            ...
            <table class="table-auto w-full border">
                <thead>
                    <tr>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortBoard('director_phone')"
                        >
                            شماره تماس ریس
                        </TableHeaderCell>
                        ...
                        <TableHeaderCell
                            ...
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortBoard('secretary_phone')"
                        >
                            شماره تماس سکرتر
                        </TableHeaderCell>

                        <TableHeaderCell
                            field="metting_per_month"
                            :sortDirection="sortDirection"
                            :sortField="sortField"
                            @click="sortBoard('metting_per_month')"
                        >
                            تعداد جلسات هر ماه
                        </TableHeaderCell>
                ...
                <tbody v-if="boards.loading || !boards.data.length">
                    <tr>
                        <td colspan="10">
                            <Spinner v-if="boards.loading" />
                ...
                <tbody class="border" v-else>
                    <tr v-for="(board, index) of boards.data" :key="index">
                        ...
                        <td class="border p-3">
                            {{ board.director_phone }}
                        </td>

                        <td class="border p-3">
                            {{ board.secretary_phone }}
                        </td>

                        <td class="border p-3">
                            {{ board.metting_per_month }}
                        </td>
            ...
            <div
                ...
                dir="ltr"
            >
                <div v-if="boards.data">
                    نمایش از {{ boards.from }} تا {{ boards.to }}
                </div>
                <nav
                    v-if="boards.total > boards.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination"
                >
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a
                        v-for="(link, i) of boards.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
...
import BoardMemberList from "../boardMember/index.vue";
import WrapperModal from "../graduatedStudent/Modal.vue";
import createBoard from "./create.vue";
...
function deleteBoard(id) {
    ...
    if (boardStore.msg_success != null) {
    }
    getBoard();
}
