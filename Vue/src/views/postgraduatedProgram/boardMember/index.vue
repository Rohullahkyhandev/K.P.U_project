<template>
    <div class="form--padding--top">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="text--header">لسیت اعضای بورد ها</div>
        </div>
        ...
        <div class="table--wrapper--dev">
            ...
            <div
                ...
                v-if="boardMemberStore.msg_success"
            >
            ...
            <div
                ...
                v-if="boardMemberStore.msg_wrang"
            >
                <div class="flex items-center justify-between px-10">
                    <div
            ...
            <div class="flex justify-between border-b-2 pb-3">
                ...
                <div class="flex items-center">
                    ...
                    &nbsp;
                    <span class="ml-3"
                        >پیداشد {{ boardMembers.total }} دیتا</span
                    >
                </div>
            </div>
            ...
            <table class="table-auto w-full border">
                ...
                <tbody
                    v-if="boardMembers.loading || !boardMembers.data?.length"
                >
                    <tr>
                        <td colspan="10">
                            <Spinner v-if="boardMembers.loading" />
                ...
                <tbody class="border" v-else>
                    <tr
                        v-for="(board_member, index) of boardMembers.data"
                        :key="index"
                    >
            ...
            <div
                v-if="!boardMembers.loading"
                class="flex justify-between items-center mt-5"
                dir="ltr"
            >
                <div v-if="boardMembers.data">
                    نمایش از {{ boardMembers.from }} تا {{ boardMembers.to }}
                </div>
                <nav
                    v-if="boardMembers.total > boardMembers.limit"
                    class="relative z-0 inline-flex justify-center rounded-md shadow-sm -space-x-px"
                    aria-label="Pagination"
                >
                    <!-- Current: "z-10 bg-indigo-50 border-indigo-500 text-indigo-600", Default: "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" -->
                    <a
                        v-for="(link, i) of boardMembers.links"
                        :key="i"
                        :disabled="!link.url"
                        href="#"
...
import createBoradMember from "./create.vue";
import { Menu, MenuButton, MenuItem, MenuItems } from "@headlessui/vue";
// import { PencilAltIcon, PencilIcon, TrashIcon } from '@heroicons/vue/24/outline'
import { useRoute, useRouter } from "vue-router";
import useBoardMemberStore from "../../../stores/postgraduatedPrograms/boardMemberStore";
...
const search = ref("");
const boardMembers = computed(() => boardMemberStore.boardMembers);
...
function getForPage(ev, link) {
    ...
    getBoardMember(link.url);
}

function getBoardMember(url = null) {
...
function sortBoardMember(field) {
...
function deleteBoardMember(id) {
    ...
    boardMemberStore.deleteBoardMember(id);
    if (boardMemberStore.msg_success != null) {
    }
    getBoardMember();
}

// modal box componets
const title = ref("فورم ثبت اطلاعات صنف های درسی ");
