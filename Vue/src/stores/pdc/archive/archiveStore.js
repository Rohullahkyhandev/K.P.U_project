...
export const useArchiveStore = defineStore('archive', () => {
    ...
    function createArchive(data) {
        ...
        data = form;
        axiosClient.post('/pdc/archive/create', data)
            .then((res) => {
                loading.value = false;
    ...
    function getArchives({ url = null, per_page, search = '', sortDirection, sortField } = {}) {
    ...
    function editArchive(id) {
        ...
        axiosClient.get(`/pdc/archive/edit/${id}`)
            .then((res) => {
    ...
    function UpdateArchive(data) {
        ...
        data = form;
        axiosClient.post('/pdc/archive/update', data)
            .then((res) => {
                loading.value = false;
                msg_success.value = res.data.message;
    ...
    function deleteArchive(id) {
        Archives.value.loading = true
        axiosClient.get(`/pdc/archive/delete/${id}`)
            .then((res) => {
                Archives.value.loading = false
                if (res.status == 200) {
