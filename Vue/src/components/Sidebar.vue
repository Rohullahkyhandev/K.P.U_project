<template>
    <aside class="bg-indigo-900 shadow w-64 hidden  sm:block">
        <div class="flex items-center justify-center mt-1 py-2 border-gray-500 border-b ">
            <img src="../../public/logo.PNG" class="w-20 " alt="">
        </div>
        <nav class="flex items-start justify-start flex-col">
            ...
            <ul class="mt-3 w-full">
                ...
                <li v-if="admin"
                    ...
                    <router-link :to="{ name: 'app.user.create' }" class="flex items-center justify-start gap-3">
