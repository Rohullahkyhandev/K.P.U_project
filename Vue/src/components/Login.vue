<template>
    <div style="
        ...
        <DefaultAuthCard subtitle="Start for free" title="صفحه ورود به سیستم">
            <form @submit.prevent="onSubmit">
                <div v-if="authStore.msg_wrang"
                    ...
                    {{ authStore.msg_wrang }}
                    <svg @click="authStore.msg_wrang = ''" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <InputGroup label=" ایمیل آدرس" type="email" v-model="user.email" required
                ...
                <InputGroup label="رمز عبور" type="password" v-model="user.password" required
...
const startWorkingHours = new Date().getHours();
const endWorkingHours = new Date().getHours();
