<template>
    <div class="w-full shadow-sm h-14 bg-white relative flex items-center justify-between">
        <div class="absolute  left-4 w-56 text-right">
            <Menu as="div" class="relative inline-block text-left w-full">
                <div class="h-14 hover:bg-gray-100 transition-colors py-2 px-3 w-full">
                    <MenuButton>
                        <div class="flex items-center justify-between w-full gap-5" @click="rotateProfile = !rotateProfile">
